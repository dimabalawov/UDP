...
int main()
{
    ...
    cout << "Enter login and colour code(example: 14:dima): \n" ;
    char loginBuf[1024]{};
    cin >> loginBuf;
    ...
    strcat_s(loginBuf, ": ");
    strcat_s(loginBuf,sendBuf);

    cout << "Sending data...." << endl;
    int sendResult = sendto(udpSocket, loginBuf, strlen(loginBuf), 0, (SOCKADDR*)&addrTo, sizeof(addrTo));
